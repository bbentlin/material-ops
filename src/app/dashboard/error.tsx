      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 border border-amber-200 dark:border-amber-900/50 rounded-xl p-6 shadow-sm">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:bg-gray-700 transition-colors"
          >
